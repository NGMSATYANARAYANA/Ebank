...
@Entity
@Table(name="Register_tnx")
public class RegistrationEntityTnx {
	@Id
	...
	public RegistrationEntityTnx(int registerid, int requestid, String firstname, String secondname, String sex,
